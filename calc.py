...
buttonplus = tk.Button(cal, text=" +", font=("arial", 20, "bold"), bd=4, padx=8, command=lambda: click("+"))
...
buttondivision = tk.Button(cal, text=" /", font=("arial", 20, "bold"), bd=5, padx=11, command=lambda: click("/"))
buttondivision.grid(row=4, column=4)

buttonzero = tk.Button(cal, text="=", font=("arial", 20, "bold"), bd=5, padx=140,command=sum)
buttonzero.grid(row=5, columnspan=5)
